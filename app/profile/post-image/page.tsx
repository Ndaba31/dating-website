    ...
    return (
        <main className='p-2'>
            ...
            <form method='post' className='flex flex-col justify-center items-center my-4'>
                <div className={`border-2 rounded-xl mb-4 w-[300px] md:w-[400px] h-[400px] ${post ? '' : 'flex justify-center items-center'}`} style={{ border: 'dotted' }}>
                    {
                        post ? (
                ...
                <div className='flex flex-col items-center'>
                    ...
                    />
                    <button type="button" onClick={() => router.back()} className='border-[#A238FF] border-2 text-white py-2 px-16 rounded-lg my-1'>Back</button>
                </div>
            </form>
        </main>
    )
